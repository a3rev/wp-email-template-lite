...
class a3_simple_html_dom_node
{
	 ...
	 *
	 * Adds itself to the list of DOM Nodes {@see a3_simple_html_dom::$nodes}
	 */
	 ...
	 * {@see a3_simple_html_dom_node::parse_selector()}
	 *
...
class a3_simple_html_dom
{
	 ...
	 * string length of ({@see a3_simple_html_dom::$doc}).
	 *
	 ...
	 * Current character
	 *
	 * Holds the current character at position {@see a3_simple_html_dom::$pos} in
	 * the document {@see a3_simple_html_dom::$doc}
	 *
	 ...
	 *
	 * Noise is stored to {@see a3_simple_html_dom::$noise}
	 *
	 ...
	 *
	 * Noise is restored from {@see a3_simple_html_dom::$noise}
	 *
	...
	{
		return @a3_str_get_html("<$name>$value</$name>")->first_child();
	}

	function createTextNode($value)
	{
		return @end(a3_str_get_html($value)->nodes);
	}
