...
class WP_Email_Template_Style_Header_Settings extends WP_Email_Tempate_Admin_UI
{
...
$wp_email_template_style_header_settings = new WP_Email_Template_Style_Header_Settings();
