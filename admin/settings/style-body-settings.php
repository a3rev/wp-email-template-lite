...
class WP_Email_Template_Style_Body_Settings extends WP_Email_Tempate_Admin_UI
{
	...
	public function subtab_data() {
		...
		$subtab_data = array(
			'name'				=> 'style-body',
			'label'				=> __( 'Body', 'wp-email-template' ),
	...
	public function init_form_fields() {
		...
		if ( is_admin() && in_array (basename($_SERVER['PHP_SELF']), array('admin.php') ) && isset( $_GET['page'] ) && $_GET['page'] == 'wp_email_template' ) {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name' 		=> __( 'EMAIL CONTENT CONTAINER PREMIUM STYLE OPTIONS', 'wp-email-template' ),
				'type' 		=> 'heading',
				'id'		=> 'email_content_premium_box',
				'is_box'	=> true,
				'alway_open'=> true,
				'desc'		=> '<img class="rwd_image_maps" src="'.WP_EMAIL_TEMPLATE_IMAGES_URL.'/premium-email-content.png" usemap="#emailContentContainerMap" style="width: auto; max-width: 100%;" border="0" />
<map name="emailContentContainerMap" id="emailContentContainerMap">
