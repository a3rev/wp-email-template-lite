...
class WP_Email_Template_Style_Header_Image_Settings extends WP_Email_Tempate_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Settings successfully saved.', 'wp-email-template' ),
				'error_message'		=> __( 'Error: General Settings can not save.', 'wp-email-template' ),
				'reset_message'		=> __( 'Settings successfully reseted.', 'wp-email-template' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array(
			'name'				=> 'header-image',
			'label'				=> __( 'Header Image', 'wp-email-template' ),
	...
	public function init_form_fields() {
		...
		if ( is_admin() && in_array (basename($_SERVER['PHP_SELF']), array('admin.php') ) && isset( $_GET['page'] ) && $_GET['page'] == 'wp_email_template' ) {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Header Image', 'wp-email-template' ),
                'type' 		=> 'heading',
                'id'		=> 'header_image_box',
                'is_box'	=> true,
           	),
			...
			array(
				'name' 		=> __( 'Header Image Alignment', 'wp-email-template' ),
				'id' 		=> 'header_image_alignment',
				'type' 		=> 'select',
				'default'	=> 'left',
				'options'	=> array(
					'none'		=> __( 'None', 'wp-email-template' ),
					'left'	=> __( 'Left', 'wp-email-template' ),
					'right'		=> __( 'Right', 'wp-email-template' ),
					'center'	=> __( 'Center', 'wp-email-template' ),
				),
				'css' 		=> 'width:160px;',
			),
			array(
				'name' 		=> __( 'Image Link URL', 'wp-email-template' ),
				'id' 		=> 'header_image_url',
				'type' 		=> 'text',
				'default'	=> '',
			),
			...
			array(
            	'name' 		=> __( 'Header Image Container', 'wp-email-template' ),
                'type' 		=> 'heading',
                'id'		=> 'header_image_container_box',
                'is_box'	=> true,
           	),
			array(
				'name' 		=> __( 'Container Border Margin', 'wp-email-template' ),
				'desc'		=> __( 'Margin or space outside of the Image container border in px.', 'wp-email-template' ),
				'id' 		=> 'header_image_margin',
				'type' 		=> 'array_textfields',
				'ids'		=> array(
	 								array(
											'id' 		=> 'header_image_margin_top',
	 										'name' 		=> __( 'Top', 'wp-email-template' ),
	 										'css'		=> 'width:40px;',
	 										'default'	=> 0 ),
	 								array(  'id' 		=> 'header_image_margin_bottom',
	 										'name' 		=> __( 'Bottom', 'wp-email-template' ),
	 										'css'		=> 'width:40px;',
	 										'default'	=> 20 ),
									array(
											'id' 		=> 'header_image_margin_left',
	 										'name' 		=> __( 'Left', 'wp-email-template' ),
	 										'css'		=> 'width:40px;',
	 										'default'	=> 0 ),
									array(
											'id' 		=> 'header_image_margin_right',
	 										'name' 		=> __( 'Right', 'wp-email-template' ),
	 										'css'		=> 'width:40px;',
	 										'default'	=> 0 ),
	 							)
			),
			array(
				'name' 		=> __( 'Container Border Padding', 'wp-email-template' ),
				'desc'		=> __( 'Padding or space between the border and the image.', 'wp-email-template' ),
			...
			array(
				'name' 		=> __( 'Container Background Colour', 'wp-email-template' ),
				'desc' 		=> __( "Header background colour.", 'wp-email-template' ),
				'id' 		=> 'header_image_background_color',
				'type' 		=> 'bg_color',
				'default'	=> array( 'enable' => 0, 'color' => '#FFFFFF' )
			),

			array(
            	'name' 		=> __( 'Image Container Borders', 'wp-email-template' ),
				'desc'		=> __( 'Please note all versions of Microsoft Outlook do not support borders. Most other Email Clients and all mobile email including Windows phone do.', 'wp-email-template' ) . '</a>',
                'type' 		=> 'heading',
                'id'		=> 'image_container_borders_box',
                'is_box'	=> true,
           	),
			array(
				'name' 		=> __( 'Border Top', 'wp-email-template' ),
			...
			array(
				'name' 		=> __( 'Border Bottom', 'wp-email-template' ),
			...
			array(
				'name' 		=> __( 'Border Left', 'wp-email-template' ),
			...
			array(
				'name' 		=> __( 'Border Right', 'wp-email-template' ),
			...
			array(
				'name' 		=> __( 'Border Corners', 'wp-email-template' ),
