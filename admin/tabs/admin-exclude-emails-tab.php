...
<?php
/*-----------------------------------------------------------------------------------
WP Email Template Exclude Emails Tab
...
class WP_Email_Template_Exclude_Emails_Tab extends WP_Email_Tempate_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wp_email_template_exclude_emails_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/exclude-emails-settings.php' );
...
$wp_email_template_exclude_emails_tab = new WP_Email_Template_Exclude_Emails_Tab();

/** 
 * wp_email_template_exclude_emails_tab_manager()
 * Define the callback function to show tab content
 */
function wp_email_template_exclude_emails_tab_manager() {
	global $wp_email_template_exclude_emails_tab;
	$wp_email_template_exclude_emails_tab->tab_manager();
}
